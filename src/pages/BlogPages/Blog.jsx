...
//   useEffect(() => {
//     // If an ID is provided in the URL, find that article
//     if (id) {
...
//       navigate(`/blog/${articleData[0].id}`);
//     }
//   }, [id, navigate]);
...
//                 {/* Article content - you might want to expand this in your data structure */}
//                 <div className="prose max-w-none">
//                   <p className="mb-4">
//                     {selectedArticle.content || "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam in dui mauris. Vivamus hendrerit arcu sed erat molestie vehicula. Sed auctor neque eu tellus rhoncus ut eleifend nibh porttitor. Ut in nulla enim."}
//                   </p>
//                   <p className="mb-4">
...
// Blog.jsx - Updated with delete functionality for admins
import React, { useState, useEffect } from "react";
import CommonBanner from "../../components/common/CommonBanner";
import { articleData } from "../../components/common/data";
import { useParams, useNavigate } from "react-router-dom";
